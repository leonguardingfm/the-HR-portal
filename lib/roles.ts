...
export const ROLE_OPTIONS: RoleOption[] = [
  ...
  },
  {
    id: "sales",
    label: "Sales",
    description: "See clients, their sites and open requirements. No operational or screening powers.",
  },
  {
    id: "client",
    label: "Client",
    description: "An external client contact. Sees the client portal and nothing internal.",
  },
];
