...
export const NAV: NavItem[] = [
  ...
  {
    href: "/duty/site-issues",
    label: "Site issues",
    purpose: "What officers find wrong at clients' sites — reviewed here before the client sees it, and checked on site once fixed.",
    group: "Control Room",
    roles: CONTROL_ROOM,
    built: true,
  },
  ...
  // --- Client --------------------------------------------------------------
  {
    href: "/client-portal",
    label: "Overview",
    purpose: "Your sites today, your open requests, and who to call.",
    group: "Client",
    roles: ["client"],
    built: true,
  },
  {
    href: "/client-portal/live",
    label: "On duty now",
    purpose: "Every officer on duty at your sites right now, and those due in the next few hours.",
    group: "Client",
    roles: ["client"],
    built: true,
  },
  {
    href: "/client-portal/rota",
    label: "Coming up",
    purpose: "The next two weeks of cover at your sites.",
    group: "Client",
    roles: ["client"],
    built: true,
  },
  {
    href: "/client-portal/shifts",
    label: "Shift record",
    purpose: "Each finished shift: when the officer arrived, the check calls made, and anything reported.",
    group: "Client",
    roles: ["client"],
    built: true,
  },
  {
    ...
    label: "Incidents",
    purpose: "Notable and serious incidents at your sites.",
    group: "Client",
    roles: ["client"],
    built: true,
  },
  {
    href: "/client-portal/site-issues",
    label: "Needs attention",
    purpose: "Things our officers have found at your sites that need putting right — broken locks, leaks, damage — and whether each is fixed.",
    group: "Client",
    roles: ["client"],
    built: true,
  },
  {
    ...
    label: "Requests",
    purpose: "Ask for extra cover, a change, or anything else — and follow it through to done.",
    group: "Client",
    roles: ["client"],
    built: true,
  },
  {
    href: "/client-portal/report",
    label: "Monthly report",
    purpose: "The month in figures: cover delivered, arrival on time, check calls, incidents and requests.",
    group: "Client",
    roles: ["client"],
    built: true,
  },
